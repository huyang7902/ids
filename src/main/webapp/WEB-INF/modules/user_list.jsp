...
<body>
	<nav class="breadcrumb">
		...
		${college } <span class="c-gray en">&gt;</span> ${major } <a
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				data-href="article-add" onclick="Hui_admin_tab(this)"
				href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加监考</a></span> <span
		...
		<table class="table table-border table-bordered table-bg table-sort">
			<thead>
				<tr>
					<th scope="col" colspan="9">监考列表</th>
				</tr>
				<tr class="text-c">
	...
	<script type="text/javascript">
		...
		/* 搜索功能 */
		function search() {
			var datemin = $("#datemin").val();//获取最小时间
			var datemax = $("#datemax").val();//获取最大时间
			var course = $("#course").val();//获取搜索课程名
			alert(datemin + "," + datemax + "," + course);
